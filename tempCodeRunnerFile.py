...
if getattr(sys, 'frozen', False):
    # Esto apunta al directorio temporal del ejecutable donde PyInstaller extrae los recursos
    os.chdir(sys._MEIPASS)
else:
    # Si lo estás ejecutando manualmente, asegúrate de usar la carpeta del proyecto
